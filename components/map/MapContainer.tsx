...
export default function MapContainer({ className, style }: { className?: string; style?: React.CSSProperties }) {
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      // Switch all text labels to Chinese
      ...
      map.on("mousemove", "province-circles", (e) => {
  ...
  return (
    <div
      className={`data-card overflow-hidden ${className || ""}`}
      style={{
        width: "100%",
        height: "100%",
        ...style,
